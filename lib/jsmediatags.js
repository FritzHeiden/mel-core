          ...
          var ArrayFileReader = (function (_MediaFileReader) {
            ...
            function ArrayFileReader (array) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (
                  ArrayFileReader.__proto__ ||
                  Object.getPrototypeOf(ArrayFileReader)
                ).call(this)
              )
          ...
          var BlobFileReader = (function (_MediaFileReader) {
            ...
            function BlobFileReader (blob) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (
                  BlobFileReader.__proto__ ||
                  Object.getPrototypeOf(BlobFileReader)
                ).call(this)
              )
          ...
          var FLACTagReader = (function (_MediaTagReader) {
            ...
            function FLACTagReader () {
              ...
              return _possibleConstructorReturn(
                this,
                (
                  FLACTagReader.__proto__ ||
                  Object.getPrototypeOf(FLACTagReader)
          ...
          var ID3v1TagReader = (function (_MediaTagReader) {
            ...
            function ID3v1TagReader () {
              ...
              return _possibleConstructorReturn(
                this,
                (
                  ID3v1TagReader.__proto__ ||
                  Object.getPrototypeOf(ID3v1TagReader)
                ).apply(this, arguments)
              )
            }
              ...
              },
              {
                ...
                value: function readFrames (offset, end, data, id3header, tags) {
                  ...
                  while (
                    ...
                    var readFrameFunc = ID3v2FrameReader.getFrameReaderFunction(
                      frameId
                    )
          ...
          var ID3v2TagReader = (function (_MediaTagReader) {
            ...
            function ID3v2TagReader () {
              ...
              return _possibleConstructorReturn(
                this,
                (
                  ID3v2TagReader.__proto__ ||
                  Object.getPrototypeOf(ID3v2TagReader)
                ).apply(this, arguments)
              )
            }
          ...
          var MP4TagReader = (function (_MediaTagReader) {
            ...
            function MP4TagReader () {
              ...
              return _possibleConstructorReturn(
                this,
                (
                  MP4TagReader.__proto__ || Object.getPrototypeOf(MP4TagReader)
                ).apply(this, arguments)
              )
            }
          ...
          var XhrFileReader = (function (_MediaFileReader) {
            ...
            function XhrFileReader (url) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (
                  XhrFileReader.__proto__ ||
                  Object.getPrototypeOf(XhrFileReader)
                ).call(this)
              )
                ...
                },
                {
                  ...
                  value: function setConfig (config) {
                    ...
                    for (var i = 0; i < disallowedXhrHeaders.length; i++) {
                      disallowedXhrHeaders[i] = disallowedXhrHeaders[
                        i
                      ].toLowerCase()
                    }
                  }
              ...
              },
              {
                ...
                value: function _findFileReader () {
                  for (var i = 0; i < mediaFileReaders.length; i++) {
                    if (
                      !mediaFileReaders[i] ||
                      !mediaFileReaders[i].canReadFile
                    ) {
                      continue
                    }
